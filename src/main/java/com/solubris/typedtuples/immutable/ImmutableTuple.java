...
public interface ImmutableTuple {
    static ImmutableUnit of() {
        return ImmutableUnitImpl.INSTANCE;
    }

    static <A> ImmutableSingle<A> of(A a) {
        return new ImmutableSingleImpl<>(a);
    }

    static <A> ImmutableSingle<A> copyOf(Single<A> t) {
        return new ImmutableSingleImpl<>(t.get());
    }

    static <A, B> ImmutableCouple<A, B> of(A a, B b) {
        return new ImmutableCoupleImpl<>(a, b);
    }

    static <A, B> ImmutableCouple<A, B> copyOf(Couple<A, B> t) {
        return new ImmutableCoupleImpl<>(t.getFirst(), t.get());
    }

    static <A, B, C> ImmutableTriple<A, B, C> of(A a, B b, C c) {
        return new ImmutableTripleImpl<>(a, b, c);
    }

    static <A, B, C> ImmutableTriple<A, B, C> copyOf(Triple<A, B, C> t) {
        return new ImmutableTripleImpl<>(t.getFirst(), t.getSecond(), t.get());
    }

    static <A, B, C, D> ImmutableQuadruple<A, B, C, D> of(A a, B b, C c, D d) {
        return new ImmutableQuadrupleImpl<>(a, b, c, d);
    }

    static <A, B, C, D> ImmutableQuadruple<A, B, C, D> copyOf(Quadruple<A, B, C, D> t) {
        return new ImmutableQuadrupleImpl<>(t.getFirst(), t.getSecond(), t.getThird(), t.get());
    }

    static <A, B, C, D, E> ImmutableQuintuple<A, B, C, D, E> of(A a, B b, C c, D d, E e) {
        return new ImmutableQuintupleImpl<>(a, b, c, d, e);
    }

    static <A, B, C, D, E> ImmutableQuintuple<A, B, C, D, E> copyOf(Quintuple<A, B, C, D, E> t) {
        return new ImmutableQuintupleImpl<>(t.getFirst(), t.getSecond(), t.getThird(), t.getFourth(), t.get());
    }

    static <A, B, C, D, E, F> ImmutableSextuple<A, B, C, D, E, F> of(A a, B b, C c, D d, E e, F f) {
        return new ImmutableSextupleImpl<>(a, b, c, d, e, f);
    }

    static <A, B, C, D, E, F> ImmutableSextuple<A, B, C, D, E, F> copyOf(
            Sextuple<A, B, C, D, E, F> t) {
        return new ImmutableSextupleImpl<>(t.getFirst(), t.getSecond(), t.getThird(), t.getFourth(), t.getFifth(), t.get());
    }

    static <A, B, C, D, E, F, G> ImmutableSeptuple<A, B, C, D, E, F, G> of(A a, B b, C c, D d, E e,
            F f, G g) {
        return new ImmutableSeptupleImpl<>(a, b, c, d, e, f, g);
    }

    static <A, B, C, D, E, F, G> ImmutableSeptuple<A, B, C, D, E, F, G> copyOf(
    ...
    static <A, B, C, D, E, F, G, H> ImmutableOctuple<A, B, C, D, E, F, G, H> of(A a, B b, C c, D d,
            E e, F f, G g, H h) {
        return new ImmutableOctupleImpl<>(a, b, c, d, e, f, g, h);
    }

    static <A, B, C, D, E, F, G, H> ImmutableOctuple<A, B, C, D, E, F, G, H> copyOf(
    ...
    static <A, B, C, D, E, F, G, H, I> ImmutableNonuple<A, B, C, D, E, F, G, H, I> of(A a, B b, C c,
            D d, E e, F f, G g, H h, I i) {
        return new ImmutableNonupleImpl<>(a, b, c, d, e, f, g, h, i);
    }

    static <A, B, C, D, E, F, G, H, I> ImmutableNonuple<A, B, C, D, E, F, G, H, I> copyOf(
    ...
    static <A, B, C, D, E, F, G, H, I, J> ImmutableDecuple<A, B, C, D, E, F, G, H, I, J> of(A a,
            B b, C c, D d, E e, F f, G g, H h, I i, J j) {
        return new ImmutableDecupleImpl<>(a, b, c, d, e, f, g, h, i, j);
    }

    static <A, B, C, D, E, F, G, H, I, J> ImmutableDecuple<A, B, C, D, E, F, G, H, I, J> copyOf(
