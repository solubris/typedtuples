...
class TripleTest {
    ...
    void compareByAllFieldsInOrderDefault() {
        var t1 = ImmutableTuple.of(1, 1, 1);
        var t2 = ImmutableTuple.of(1, 1, 2);
        var t3 = ImmutableTuple.of(2, 1, 1);
        var list = new ArrayList<>(List.of(t3, t2, t1));
        list.sort(Triple.compareByAllFieldsInOrder());
    ...
    void compareByAllFieldsInReverseOrderDefault() {
        ...
        var t3 = ImmutableTuple.of(2, 1, 1);
        var list = new ArrayList<>(List.of(t3, t2, t1));
        list.sort(Triple.compareByAllFieldsInReverseOrder());
    ...
    void compareByAllFieldsInOrderCustomExtractor() {
        ...
        var t3 = ImmutableTuple.of(2, 1, 1);
        var list = new ArrayList<>(List.of(t3, t2, t1));
        list.sort(Triple.compareByAllFieldsInOrder(i -> i * i, i -> i * i, i -> i * i));
        Assertions.assertThat(list).containsExactly(t1, t2, t3);
    }
    ...
    void compareByAllFieldsInReverseOrderCustomExtractor() {
        ...
        var t3 = ImmutableTuple.of(2, 1, 1);
        var list = new ArrayList<>(List.of(t3, t2, t1));
        list.sort(Triple.compareByAllFieldsInReverseOrder(i -> i * i, i -> i * i, i -> i * i));
        Assertions.assertThat(list).containsExactly(t1, t3, t2);
    }
    ...
    void compareByAllFieldsInOrderCustomComparators() {
        ...
        var t3 = ImmutableTuple.of(2, 1, 1);
        var list = new ArrayList<>(List.of(t3, t2, t1));
        list.sort(Triple.compareByAllFieldsInOrder(Integer::compareTo, Integer::compareTo, Integer::compareTo));
        Assertions.assertThat(list).containsExactly(t1, t2, t3);
    }
    ...
    void compareByAllFieldsInReverseOrderCustomComparators() {
        ...
        var t3 = ImmutableTuple.of(2, 1, 1);
        var list = new ArrayList<>(List.of(t3, t2, t1));
        list.sort(Triple.compareByAllFieldsInReverseOrder(Integer::compareTo, Integer::compareTo, Integer::compareTo));
        Assertions.assertThat(list).containsExactly(t1, t3, t2);
    }
}
